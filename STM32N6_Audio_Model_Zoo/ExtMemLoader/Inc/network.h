...
#define LL_ATON_DEFAULT_ORIGIN_MODEL_NAME   "stft_tcnn_medium_sigmoid_257xsl_qdq_int8"
...
#define LL_ATON_DEFAULT_IN_1_SIZE_BYTES  (257)

/************************** OUTPUTS *******************************************/
#define LL_ATON_DEFAULT_OUT_NUM        (1)    // Total number of output buffers
// Output buffer 1 -- Sigmoid_88_out_0
#define LL_ATON_DEFAULT_OUT_1_ALIGNMENT   (32)
#define LL_ATON_DEFAULT_OUT_1_SIZE_BYTES  (1028)
