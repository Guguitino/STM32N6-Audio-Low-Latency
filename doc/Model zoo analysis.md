Ce document est une analyse du dépôt [STM32N6-GettingStarted-Audio](https://github.com/STMicroelectronics/STM32N6-GettingStarted-Audio) fourni pat STMicroelectronics.

Il est l'application utilisée pour le déploiement des modèles de speech enhancement et d'audio event detection fournit dans le ST Model Zoo.
