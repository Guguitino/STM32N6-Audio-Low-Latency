...
#define PROC_BUFFER_SIZE            (PATCH_LENGTH*4)
#define PLAYBACK_BUFFER_SIZE (320)
...
extern bool audio_process(AudioBM_acq_t * acq_ctx_ptr,\
						  ...
						  uint16_t audio_acq_len);
extern bool audio_process_low_latency(AudioBM_acq_t * acq_ctx_ptr,\
							AudioBM_ll_t * ll_ctx_ptr,\
